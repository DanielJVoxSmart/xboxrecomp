/**
 * Burnout 2 - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x000E2555  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Burnout 2 - Point of Impact\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Burnout 2 - Point of Impact"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Burnout 2 - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            snprintf(message, sizeof message,
                     ...
                     "Looked for:\n%s", tried);
            fprintf(stderr, "%s\n", message);
            MessageBoxA(NULL, message, "Burnout 2", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
