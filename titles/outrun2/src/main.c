/**
 * Outrun 2 - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x000F33CD  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Outrun 2\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Outrun 2"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Outrun 2 - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Outrun 2", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
