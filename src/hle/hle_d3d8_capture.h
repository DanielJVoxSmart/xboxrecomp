 ...
 *
 * They come from the title's constant setters (hle_d3d8_vertex.c,
 * forward_constants). The viewport constants 58 and 59, which shadow mode
 * sets itself, are not recorded here: they are in the frame-start bank. */
